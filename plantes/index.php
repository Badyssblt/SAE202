...
?>
<h2 class="font-bold text-2xl text-center mt-8 underline md:py-2 md:rounded-xl md:pl-8 md:no-underline" style="color: #3E572D; font-family: Quicksand;">Nos plantes</h2>
