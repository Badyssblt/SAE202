<?php
$activePage = "admin";
$title = "Planta | Gestion des demandes";
...
<div class="flex flex-col md:flex-row md:flex-wrap px-10 gap-6 justify-center">
    ...
    <div class="border md:w-1/3 rounded-md w-full">
        ...
        <div class="px-6  py-4">
            <h2 class="font-bold text-3xl mb-2">Gestions du réseau social</h2>
            <p class="mb-4 text-slate-600">Créer, modifier, et supprimer la partie réseau social du site</p>
            <a href="./social/listSocial.php" class="bg-main rounded-full w-full px-8 py-2">Voir</a>
        </div>
