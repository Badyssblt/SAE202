...
<div class="px-8">
    ...
    <div class="flex flex-col gap-2 md:flex-row ">
        ...
        <a href="../users/listUsers.php" class="bg-main text-white py-2 px-4 rounded-full flex justify-center mt-2">Liste des utilisateurs</a>
    ...
    <button class="bg-main text-white py-2 px-4 rounded-sm flex justify-center my-2" onclick="displayForm()">Créer un utilisateur</button>
