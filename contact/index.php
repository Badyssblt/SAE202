...
<h2 class="font-bold text-2xl text-center underline md:py-2 md:text-3xl md:rounded-xl md:text-center md:no-underline" style="color: #3E572D; font-family: Quicksand">Contact</h2>
...
<form action="../process/mail.proc.php" method="POST" style="border: 2px solid #475C37;" class="w-11/12 px-8 py-6 rounded-lg md:w-2/5">
    <div class="flex flex-col">
        ...
        <input type="text" name="subject" id="subject" placeholder="Sujet du mail" class="border rounded-md pl-4 py-2">
    </div>
